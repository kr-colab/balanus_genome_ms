...
\newcommand{\comment}[1]{{\color{RedViolet} #1}}
...
for this species.
\comment{From Scott: I dont think this is relevant. esp since you immediately discuss
the population. If you want to discuss individuals in terms of variation something about
haplotypes being XX\% diff.}
\comment{Angel idea: This assembly reveals a highly polymorphic genome with over 3\%
heterozygosity.}
This assembly reveals high levels of genetic polymorphism \st{even in a single individual}.

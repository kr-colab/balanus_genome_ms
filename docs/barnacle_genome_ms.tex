...
and alignment difficulty \citep{gillespie_characterizing_2004}, and not an accurate
...
% TODO: Checking some details from Taco
...
\texttt{eggNOG} (downloaded 2025/07/08),
\texttt{NCBI nr} (downloaded 2025/10/08),
\texttt{RefSeq Protein} (downloaded 2025/08/08),
\texttt{Swiss-Prot} (downloaded 2025/08)/08,cd 
and \texttt{InterProScan} (downloaded 2025/07/25).
...
using the \textsc{agat} software version \texttt{1.4.3} \citep{dainat_another_2022}

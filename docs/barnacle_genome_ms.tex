...
\cite{smith_adaptive_2002}), Neutrality Index (NI; \cite{rand_excess_1996})
and Direction of Selection (DoS; \cite{stoletzki_estimation_2011}).
...
\subsubsection*{Codon usage biases in \textit{Drosophila melanogaster}}
...
adjustments by \cite{sun_improved_2013} to account for for usage differences across
different codon subfamilies.

\subsubsection*{Nucleotide diversity in \textit{Drosophila melanogaster}}

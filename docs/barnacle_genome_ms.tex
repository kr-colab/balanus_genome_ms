...
estimates of $\theta_\text{W}$ from \textsc{pixy}, and using the relationship
...
\subsection*{Assembly and annotation of \textit{Balanus
...
While these is $\approx$ 5,000 fewer protein-coding genes than those annotated for
...
\subsection*{Processing annotations of published barnacle

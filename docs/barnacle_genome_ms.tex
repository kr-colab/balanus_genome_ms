...
nunez_footprints_2020,rand_ecological_2002,schmidt_environmental_2000,flight_allozyme_2012}.
...
copies of the NADP-dependent malic enzyme (\textit{Me.1} and \textit{Me.2}),
...
% Note: mention that while not significant, all the other genes reflect excess polymorphism.
% This is particularly strong for Me1 and Mpi. Bring in the Pi4/Ks plots.
Add: \ref{fig:sup_gw_piks} and \ref{fig:sup_allozyme_piks}
...
\begin{figure}[ht]
    ...
    \supfigurecaption{\textbf{Distribution of synonymous diversity over synonymous
        ...
        including the seven classic allozyme loci: \textit{Adh}, \textit{Gpi},

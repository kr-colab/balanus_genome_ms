...
at 0-fold degenrate ($\pi_{0}$), in which any mutation produces a non-synonymous
...
of $\alpha$ used) of non-synonymous mutations reaching fixation due to the
...
responsible for the necessary plasticity required for survival in rapidly changing
...
% @Andy: Yes, decided to flip this and the "barnacles as models" section. I think that
% section provides a nicer end to the overall discussion.
...
Yet the McDonald-Kreitman test reveals seemingly opposite results, with $\approx61\%$
of non-synonymous substitutions that have fixed between these species were driven by
...
Moreover, as with other marine invertebrates, barnacle's life history traits are likely
direct drivers for the elevated polymorphism observed, as factors such as large census
sizes, small propagule size, long larval dispersal, and broad geographic distribution
have been positively correlated with the high genetic diversity commonly seen in these
...
% Andy: I reworked this some more. Hopefully it highlights some of these big picture
% points a bit better.
In this work, we take one of the first looks at the genomic signatures of evolution
in large population sizes in the Pacific acorn barnacle, \balgla{}.
In accordance to population genetics theory, we find evidence for the strengthening
of selection in this large barnacle population, resulting in both purifying selection
reducing diversity and maintaining conservation across functional sites, as well as
pervasive positive selection driving adaptive evolution and divergence in protein
coding genes.
To our surprise, however, we find a highly repetitive genome which is in contrast to
the expectation of purifying selection acting against the proliferation of repetitive
sequences.
Looking at diversity at the population scale, we observe average genome-wide
nucleotide diversity of over 5\%, placing this species among hyperpolymorphic
organisms.
Yet, while this diversity indicates large effective population sizes ($\approx10^{6}$
individuals), it still pales in comparison to the extremely large census sizes
observed in this population.
This finding highlights the known disparity between effective and census sizes
seen in nature, and sets \bgla{} as a promising emerging model to study the
underlying mechanisms of evolution at biological extremes.

...
evidence of positive selection in  homologs of tumor protein p53-inducible protein 11,
which is involved in cell cycle regulation and are up-regulated in crabs after viral
infection \citep{cheng_p53_2021}, as well quiver gene homologs, related to neuronal
activity and sleep regulation in \textit{Drosophila} \citep{wang_quiver_2010}.
\vspace{0.2cm}
...
observed (NI = 18.54) suggest strong balancing selection acting on this gene in
this system.
...
Among other candidates showing large $\alpha$, we find a homolog to transmembrane channel
like 7 ($\alpha = 0.985$), which has been linked to osmoregulation in crustaceans, and
a homolog to patched domain-containing protein 3-like ($\alpha = 0.983$), a key patterning
gene essential to development in \textit{Drosophila} \citep{bolatto_spatial_2015} which
exhibits male germline-specific expression in mammals \citep{fan_male_2007}.
...
\texttt{LOC122363544}.
Based on sequence similarity, \texttt{LOC122363544} is a putative homolog of formin-like
protein 3, a member of a family of proteins known to play a role in crustacean immunity
\citep{li_formin-like_2025}.
While the functions of all of these candidate genes in uknown in \bgla{}, they highlight
the diverse target of selection in this system and their characterization serves as
avenues for future study in barnacles.
...
For both of these genes, both the NI and DoS statistics show that this deviation is due an
excess of non-synonymous substitutions, indication that these sequences evolved under a
...
polymorphism relative to divergence (NI = 1.575).

...
\citep{alm_rosenblad_genomic_2021} and complex patterns of selection at remarkably small
spatial scales, most notably a balanced polymorphism at the mannose-6-phosphate isomerase
(\textit{Mpi}) locus in the northern acorn barnacle \textit{Semibalanus balanoides}
\citep{schmidt_environmental_2000,nunez_footprints_2020,nunez_tides_2021}.
However, this work has been restricted to a handful of loci, and the genome-wide landscape
of diversity and selection in barnacles remains largely unknown.
\vspace{0.2cm}
...
\textit{B. crenatus}, providing a closely related outgroup for divergence-based analyses.

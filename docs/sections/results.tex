...
\comment{@Andy, take a look at this section. I reworked it based on the GO analysis,
but I want a second pair of eyes. It feels a bit listly to me at the moment.}
...
Among our most enriched GO terms, we observe terms related to the plasma membrane (lateral
plasma membrane \texttt{GO:0016328}, apical plasma membrane \texttt{GO:0016324}, plasma membrane
protein complex \texttt{GO:0098797}),
adherens (adherens junction \texttt{GO:0005912}, zonula adherens assembly \texttt{GO:0045186},
protein localization to adherens junction \texttt{GO:0071896}, adherens junction maintenance
\texttt{GO:0034334}),
myosin (myosin II binding \texttt{GO:0045159}, myosin light chain binding \texttt{GO:0032027},
myosin II filament organization \texttt{GO:0031038}),
spectrin (spectrin binding \texttt{GO:0030507}, spectrin complex \texttt{GO:0008091}), and
collagen (collagen trimer \texttt{GO:0005581}, complex of collagen trimers \texttt{GO:0098644})
In particular, within the collagen terms we observe the enrichment processes related to the
molting of arthropod cuticles (e.g., molting cycle, collagen and cuticulin-based cuticle
\texttt{GO:0018996}).
Overall, these enrichment terms suggest there is strong directional selection in \bgla{}
in genes involved in the building and remodeling of the cell surface, interactions with the
extracelluar matrix, cell-cell adhesion, and related functions.
\vspace{0.2cm}

Several of our candidates under strong positive selection are direct components of or linked to
...
\comment{Keep this here or new section?}
Interestingly, our single candidate showing an excess of polymorphism relative to divergence
is a homolog of tubulin $\alpha$-1C chain-like, a major constituent of microtubules---thus
directly linked to the cell-remodeling mechanisms under positive selection---which has been
additionally observed as differentially expressed in response to osmotic stress in barnacles
\citep{chandramouli_transcriptome_2015}.
While its exact function in \bgla{} is unknown, the large excess of polymorphism
observed (NI = 18.54) suggests strong balancing selection acting on this gene despite strong
positive selection on the overall cell-remodeling machinery.
\vspace{0.2cm}

\comment{This is more or less what we had in the previous version of the text. Mostly talking
about the top genes based on alpha and the overlap with dNdS}
Outside of this cell remodeling/cell adhesion core, the remaining candidates of selection appear
to largely be functionally heterogenous.
The gene displaying the largest proportion of non-synonymous substitutions fixed by
positive selection among the sequences studied is a homolog to the Eukaryotic translation initiation
factor 3 subunit L ($\alpha = 0.988$), a component of an initiation factor essential for protein
synthesis and, in humans, linked to the regulation of transcripts related to cell proliferation and
growth \citep{lee_eif3_2015}.
...
levels of polymorphism, an order of magnitude higher than the diversity in Sub-Saharan

...
\begin{figure}[htbp]
    ...
    \caption{\textbf{Signatures of positive selection in \balgla{}
        ...
        enrichment among the candidates under selection among the three main GO categories:
        biological processes, cellular component, and molecular function.}
    \label{fig:mkTest}
\end{figure}

\comment{Update to GO terms here.}
...
Figure~\ref{fig:genome_pi}; Table~\ref{tab:sup_feature_pi}), a degree of diversity
that is an order of magnitude higher than that observed in diverse \textit{Drosophila}
populations in Sub-Saharan Africa (Figure~\ref{fig:sup_dmel_pi}).
\comment{Add human and anopheles comparison}
\vspace{0.2cm}

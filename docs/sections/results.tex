...
We compared biases in the usage and composition of synonymous codons in twelve metazoan
genomes, including four barnacles (Table~\ref{tab:enc_summary}), to study the effects of
translational selection in the context of large populations.
Using the annotated transcript sequences in these genomes to calculate the effective number
...
deviation: 5.52; Figure~\ref{fig:codon_enc}A; Table~\ref{tab:enc_summary}).
This number of effective codons is similar to the one observed across three other barnacle
genomes (mean ENC ranging from 42.04 to 44.33; Table~\ref{tab:enc_summary}), highlighting a substantial bias in synonymous codon usage
in barnacles when compared to other metazoans (Figure~\ref{fig:codon_enc}A).



We calculated ENC across the coding sequences of
16{,}217 \bgla{} genes, finding a mean of 43.1 effective codons (median: 42.7,
...
\begin{figure}[htbp]
    ...
    \caption{\textbf{Codon usage biases in \balgla.}
        ...
        in \bgla{} (\texttt{BalGla}) and other metazoan genomes (see Table~\ref{tab:enc_summary}),

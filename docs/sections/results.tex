...
% Angel: Reduced the genome assembly and annotation sections, previously two different
% sections with multiple paragraphs each, to just this one section. It skips some of the
% details present in the methods, whole still describing the general details of the
...
% Angel: Following one of Scott's comments, trying to minimize some of the more
...
% Low priority, but could we get a scaled version of the figure in which the text is a bit larger?

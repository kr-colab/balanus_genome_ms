...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/synteny.pdf}
...
\subsection*{Barnacle genes show a biased use of synonymous codons}
    ...
    \comment{TODO: Update this with the new results.}
...
\begin{figure}[htp]
    ...
    \caption{\textbf{Codon usage biases in \balgla.}
        ...
        in \bgla{} (\texttt{BalGla}) and other metazoan genomes, including the barnacles
        \textit{B. crenatus} (\texttt{BalCre}), \textit{A. amphitrite} (\texttt{AmpAmp}),
        and \textit{P. pollicipes} (\texttt{PolPol}). The vertical lines
        show the 50\textsuperscript{th} quantile (median) of the distribution,
...
\begin{table}[ht]
\centering
\caption{\comment{Add number of genes.} Length-filtered summary statistics (CDS $\geq$ 300 bp, within 2 SD of the per-species mean length) for the effective number of codons (ENC), GC proportion, and GC proportion at the third codon position (GC3s).}
\label{tab:enc_summary}
\begin{tabular}{lllrrrrrrrrr}
\toprule
 & & & \multicolumn{3}{c}{ENC} & \multicolumn{3}{c}{GC} & \multicolumn{3}{c}{GC3s} \\
\cmidrule(lr){4-6} \cmidrule(lr){7-9} \cmidrule(lr){10-12}
Genome          & Species                                & NCBI Accession             & Mean & Median & StDev & Mean & Median & StDev & Mean & Median & StDev \\
\midrule
\texttt{BalGla} & \balgla{}                              & This study                 & 43.17 & 42.84 & 5.52 & 0.645 & 0.648 & 0.061 & 0.781 & 0.796 & 0.102 \\
\texttt{BalCre} & \textit{Balanus crenatus}              & This study                 & 42.23 & 41.40 & 4.78 & 0.645 & 0.649 & 0.055 & 0.815 & 0.837 & 0.093 \\
\texttt{AmpAmp} & \textit{Amphibalanus amphitrite}       & \texttt{GCF\_019059575.1}  & 44.33 & 43.93 & 5.05 & 0.632 & 0.636 & 0.054 & 0.775 & 0.792 & 0.099 \\
\texttt{PolPol} & \textit{Pollicipes pollicipes}         & \texttt{GCF\_011947565.3}  & 42.04 & 41.57 & 4.56 & 0.644 & 0.648 & 0.049 & 0.829 & 0.845 & 0.082 \\
\texttt{DroMel} & \textit{Drosophila melanogaster}       & \texttt{GCF\_000001215.4}  & 49.97 & 50.47 & 3.99 & 0.534 & 0.540 & 0.053 & 0.630 & 0.640 & 0.110 \\
\texttt{AnoGam} & \textit{Anopheles gambiae}             & \texttt{GCF\_943734735.2}  & 48.43 & 48.92 & 5.09 & 0.556 & 0.566 & 0.062 & 0.667 & 0.688 & 0.136 \\
\texttt{CaeBre} & \textit{Caenorhabditis brenneri}       & \texttt{GCA\_964036135.1}  & 50.95 & 51.55 & 3.21 & 0.436 & 0.430 & 0.045 & 0.411 & 0.399 & 0.088 \\
\texttt{MagGig} & \textit{Magallana gigas}               & \texttt{GCF\_963853765.1}  & 53.34 & 53.66 & 2.58 & 0.442 & 0.441 & 0.043 & 0.433 & 0.426 & 0.085 \\
\texttt{StrPur} & \textit{Strongylocentrotus purpuratus} & \texttt{GCF\_000002235.5}  & 53.92 & 54.39 & 2.68 & 0.481 & 0.480 & 0.035 & 0.489 & 0.486 & 0.079 \\
\texttt{BraLan} & \textit{Branchiostoma lanceolatum}     & \texttt{GCF\_035083965.1}  & 51.20 & 51.78 & 3.57 & 0.537 & 0.536 & 0.043 & 0.620 & 0.619 & 0.095 \\
\texttt{CioInt} & \textit{Ciona intestinalis}            & \texttt{GCF\_018327825.1}  & 52.49 & 52.75 & 2.66 & 0.424 & 0.422 & 0.037 & 0.369 & 0.367 & 0.069 \\
\texttt{HomSap} & \textit{Homo sapiens}                  & \texttt{GCF\_000001405.40} & 49.39 & 50.57 & 4.51 & 0.538 & 0.541 & 0.087 & 0.593 & 0.603 & 0.163 \\
\bottomrule
\end{tabular}
\end{table}
...
\comment{TODO: mention something about the centromeres, recombination,

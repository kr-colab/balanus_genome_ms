...
% Add the new supplemental figure.

Exploring the predicted function of the candidate genes under positive selection
identified in the MK test, we observe an enrichment for gene ontology (GO) terms involved in the building and remodeling of the cell surface and related functions
(Figure~\ref{fig:mkTest}B).
For example, among our most enriched GO terms, we observe terms related to adherens (adherens
junction \texttt{GO:0005912}, zonula adherens assembly \texttt{GO:0045186}, protein localization
to adherens junction \texttt{GO:0071896}, adherens junction maintenance \texttt{GO:0034334}),
...
% Bring this back to the GO terms. There are some strong links.
a homolog
...
% mention that this also relates to cytoskeleton stuff so it linked to the positive
% selection genes from above.

% Some other concluding remark

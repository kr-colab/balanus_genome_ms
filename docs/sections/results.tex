...
We proceeded to re-classify this large fraction of unknown repeat elements using
\textsc{TEsorter} \citep{zhang_tesorter_2022}, followed by \textsc{DeepTE}
\citep{yan_deepte_2020},
which reduced the fraction of unclassified elements to only 5.89\% of the total assembly.

...
\comment{I dont feel like this topic needs this much attention. Just a note on the
difficulty of assembly in these cases. Like 3 sentences.}
...
selection, while the classic HKA test flags \textit{Me.1} through a deficit of
silent polymorphism relative to divergence, the signature of a recent selective
sweep at linked neutral sites. That the two paralogs are detected by different
tests is a reminder that the tempo and mode of adaptive evolution can differ
substantially even between close copies of the same gene.

\subsection*{Barnacles as models for evolution at biological extremes}

\comment{From Scott: this was good section}

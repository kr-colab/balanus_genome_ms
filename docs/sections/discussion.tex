...
% Angel: From Scott's comment, maybe we remove the first section altogether (or 1 paragraph at
% most?). We use that space to move some of the allozyme discussion here. Andy notes: We leave
% this here now and wait for review.
...
\subsection*{Revisiting the classic barnacle allozyme loci}

% Angel: Maybe a new subheader here to keep things more organized?}

In barnacles, a set of allozyme loci have been extensively linked to spatial heterogeneity
and local adaptation across varying intertidal environments \citep{flowerdew_electrophoretic_1983,
nunez_footprints_2020,rand_ecological_2002,schmidt_environmental_2000,flight_allozyme_2012,
veliz_regional_2004}.
We take advantage of our new genomic resources for \bgla{} and \textit{B. crenatus}, as well
as polymorphism data, to revisit these classic allozyme loci in this system.
% \vspace{0.2cm}

% Angel: Since I moved this to a new section, I changed the opening of this paragraph.
% Please double check.

Looking at the results from the malic enzyme paralogs, \textit{Me.1} and \textit{Me.2},
provides a locus-level example to describe the complementarity, and discordance, between
the different tests of molecular evolution we discussed above.
The MK test flags \textit{Me.2} through an excess of
...
magnitude higher than that observed in \textit{D. melanogaster} (Figure~\ref{fig:sup_dmel_pi})
